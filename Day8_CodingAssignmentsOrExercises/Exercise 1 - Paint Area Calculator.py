...
Check your code is doing what it is supposed to. When you're happy with your code, click submit to check
 your solution.
...
def paint_calc(height,width,cover):
    ...
    round_up_no_of_cans = int(math.ceil(number_of_cans))
    print(f"You'll need {round_up_no_of_cans} cans of paint")
